...
# print(int_num)
# print(type(int_num))
# # type()identiies the type of data type
# name = "tony"
# print(type(name))
# classinsession = True
...
# # Print the data type of that variable.
# decinal_num = 30.01
# print(type(decinal_num))
# # implicit or explicit conversion, implicint means it is infered while explicit means it is explicitly defined 
